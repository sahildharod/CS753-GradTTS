...
HIFIGAN_CHECKPT = './checkpts/icml-2021-submission/hifigan.pt'
...
if __name__ == '__main__':
    ...
    generator = GradTTS(len(symbols)+1, params.n_spks, params.spk_emb_dim,
                        ...
                        params.n_feats, params.dec_dim, params.beta_min, params.beta_max, params.pe_scale, params.n_timesteps)
